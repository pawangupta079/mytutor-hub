  ...
  return (
    <footer className="border-t bg-white">
      <div className="container grid gap-8 py-12 md:grid-cols-4">
        <div>
          ...
          <p className="mt-3 text-sm text-foreground/70">
            Learn smarter with expert tutors. Book sessions, track progress, and
            achieve your goals.
          </p>
          <div className="mt-4 flex gap-3 text-foreground/70">
            ...
            <a
              href="mailto:support@myofflinetutor.com"
              aria-label="Email"
        ...
        <div>
          ...
          <ul className="mt-3 grid gap-2 text-sm text-foreground/70">
            <li>
              <Link to="/find-tutor" className="hover:text-primary">
                Find a Tutor
              </Link>
            </li>
            <li>
              <Link to="/register-tutor" className="hover:text-primary">
                Register as Tutor
              </Link>
            </li>
            <li>
              <Link to="/learning-demo" className="hover:text-primary">
        ...
        <div>
          ...
          <ul className="mt-3 grid gap-2 text-sm text-foreground/70">
            ...
            <li>
              <Link to="/tutor-dashboard" className="hover:text-primary">
                Tutor
              </Link>
            </li>
            <li>
      ...
      <div className="border-t py-4 text-center text-sm text-foreground/60">
        © {new Date().getFullYear()} My_Offline_Tutor. All rights reserved.
      </div>
    </footer>
  );
}
